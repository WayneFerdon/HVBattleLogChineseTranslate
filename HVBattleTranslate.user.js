...
let words = {
  ...
  'casts?': '<span style=\"background:#7CFC00;color:black\" >咏唱了</span>',
  ...
  'restores': '<span style=\"color:#80B440\" >恢复了你</span>',
  'Recovered': '<span style=\"color:#80B440\" >恢复了你</span>',
  'You use': '<span style=\"background:#ADFF2F;color:black\" >你使用了</span>',
  'The effect (.+) was dispelled\.': '效果 $1 已被替换',
  'gains? the effect': '<span style=\"background:#ADFF2F;color:black" >获得了状态</span>',
  ...
  'Cooldown expired for (.*)': '<span style=\"color:#1E90FF\" >$1</span> <span style=\"background:#97ffb2;color:black\" >已结束冷却</span>',
  ...
  'You drain (.*) points of health from (.*)': '你从 $2 身上吸取<span style=\"color:#80B440\" > $1 点生命</span>',
  ...
  'parries your attack': '<span style=\"background:#00FFFF;color:black\" >招架了你的攻击</span>',
  'The effect (.*) on (.*) has expired': '<span style=\"color:	#b06161\" >$2 身上的状态 $1 已失效</span>',
  'resists your spell': '<span style=\"background:#81f7f3;color:black\" >抵抗了你的魔法</span>',
  ...
  '(.*) has been defeated': '<span style=\"background:#b3b3b3;color:black\" >打败了 $1</span>',
